var CatalogItem = require('./CatalogItem'); // It represent the leaf
var CatalogGroup = require('./CatalogGroup'); // It represent the Group/branch **IMPORTANT** -> Group needs to implement the same interface as the leaf (CatelogItem)
